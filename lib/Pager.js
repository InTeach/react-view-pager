...
var Track = (function(_PagerElement) {
  ...
  function Track() {
    ...
    return _possibleConstructorReturn(
      this,
      (Track.__proto__ || Object.getPrototypeOf(Track)).apply(this, arguments)
    );
  }
...
var View = (function(_PagerElement2) {
  ...
  function View(_ref) {
    ...
    var _this2 = _possibleConstructorReturn(
      this,
      (View.__proto__ || Object.getPrototypeOf(View)).call(this, restOptions)
    );
  ...
  _createClass(Pager, [
    ...
    },
    {
      ...
      value: function setCurrentView(_ref2) {
        var _ref2$direction = _ref2.direction,
          ...
          suppressEvent =
            _ref2$suppressEvent === undefined ? false : _ref2$suppressEvent;
    ...
    },
    {
      ...
      value: function getMaxDimensions(indices) {
        ...
        return {
          width:
            axis === "x" ? (0, _utils.sum)(widths) : (0, _utils.max)(widths),
          height:
            axis === "y" ? (0, _utils.sum)(heights) : (0, _utils.max)(heights)
        };
      }
    },
    {
