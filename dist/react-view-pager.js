...
(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === "object" && typeof module === "object")
    ...
    exports["ReactViewPager"] = factory(
      require("react"),
      require("resize-observer-polyfill"),
      require("get-prefix"),
      require("react-dom"),
        ...
        var ViewPager = (function(_Component) {
          ...
          function ViewPager(props) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (ViewPager.__proto__ || Object.getPrototypeOf(ViewPager)).call(
                this,
                props
              )
            );
	 ...
	 */
        ...
        var Track = (function(_PagerElement) {
          ...
          function Track() {
            ...
            return _possibleConstructorReturn(
              this,
              (Track.__proto__ || Object.getPrototypeOf(Track)).apply(
                this,
                arguments
              )
            );
          ...
          _createClass(Track, [
            {
              ...
              value: function getStyles(trackPosition) {
                var _pager$getPositionVal = this.pager.getPositionValue(
                    trackPosition
                  ),
        ...
        var View = (function(_PagerElement2) {
          ...
          function View(_ref) {
            ...
            var _this2 = _possibleConstructorReturn(
              this,
              (View.__proto__ || Object.getPrototypeOf(View)).call(
                this,
                restOptions
              )
            );
          ...
          _createClass(Pager, [
            ...
            },
            {
              ...
              value: function setCurrentView(_ref2) {
                var _ref2$direction = _ref2.direction,
                  direction =
                    _ref2$direction === undefined ? 0 : _ref2$direction,
                  _ref2$index = _ref2.index,
                  index =
                    _ref2$index === undefined ? this.currentIndex : _ref2$index,
                  _ref2$suppressEvent = _ref2.suppressEvent,
                  suppressEvent =
                    _ref2$suppressEvent === undefined
                      ? false
                      : _ref2$suppressEvent;
                ...
                var currentIndex = infinite
                  ? newIndex
                  : (0, _utils.clamp)(newIndex, 0, this.views.length - 1);
            ...
            },
            {
              ...
              value: function setPositionValue() {
                var trackPosition =
                  arguments.length > 0 && arguments[0] !== undefined
                    ? arguments[0]
                    : this.currentView ? this.currentView.target : 0;
                ...
                if (!this.isSwiping) {
                  ...
                  if (infinite) {
                    ...
                    trackPosition -=
                      (Math.floor(this.currentIndex / this.views.length) || 0) *
                      trackSize;
                  }

                  if (contain) {
                    var trackEndOffset =
                      (viewsToShow === "auto" && autoSize) || viewsToShow <= 1
                        ? 0
                        : this.getFrameSize({ autoSize: false });
                    trackPosition = (0, _utils.clamp)(
                      trackPosition,
                      trackEndOffset - trackSize,
                      0
                    );
                  }
                }
            ...
            },
            {
              ...
              value: function setViewStyles() {
                ...
                var trackSize = this.getTrackSize();
                var wrappedtrackPosition = (0, _utils.modulo)(
                  trackPosition,
                  -trackSize
                );
                ...
                this.views.reduce(function(lastPosition, view, index) {
                  ...
                  if (
                    nextPosition + viewSize * align <
                    Math.abs(wrappedtrackPosition)
                  ) {
            ...
            },
            {
              ...
              value: function getMaxDimensions(indices) {
                ...
                return {
                  ...
                  height:
                    axis === "y"
                      ? (0, _utils.sum)(heights)
                      : (0, _utils.max)(heights)
                };
              }
            },
            {
              ...
              value: function getCurrentIndicies() {
                ...
                var currentViews = [];
                var viewsToShow = isNaN(this.options.viewsToShow)
                  ? 1
                  : this.options.viewsToShow;
                ...
                if (contain) {
                  ...
                  minIndex = (0, _utils.clamp)(
                    minIndex,
                    0,
                    this.views.length - viewsToShow
                  );
                  maxIndex = (0, _utils.clamp)(
                    maxIndex,
                    0,
                    this.views.length - 1
                  );
                  ...
                  for (var _i = minIndex; _i <= maxIndex; _i++) {
                    currentViews.push(
                      infinite
                        ? (0, _utils.modulo)(_i, this.views.length)
                        : (0, _utils.clamp)(_i, 0, this.views.length - 1)
                    );
                  }
                }
            ...
            },
            {
              ...
              value: function getFrameSize() {
                var _ref3 =
                  ...
                  autoSize =
                    _ref3$autoSize === undefined
                      ? this.options.autoSize
                      : _ref3$autoSize,
                  _ref3$fullSize = _ref3.fullSize,
                  fullSize =
                    _ref3$fullSize === undefined ? false : _ref3$fullSize;
            ...
            },
            {
              ...
              value: function getTrackSize() {
                var includeLastSlide =
                  arguments.length > 0 && arguments[0] !== undefined
                    ? arguments[0]
                    : true;

                var lastIndex = includeLastSlide
                  ? this.views.length
                  : this.views.length - 1;
                var size = 0;
            ...
            },
            {
              ...
              value: function getPositionValue() {
                ...
                if (infinite) {
                  var trackSize = this.getTrackSize();
                  trackPosition =
                    (0, _utils.modulo)(trackPosition, -trackSize) || 0;
                }
          ...
          _createClass(AnimationBus, [
            {
              ...
              value: function getStyles() {
                ...
                this.animations.forEach(function(animation) {
                  ...
                  var value = (0, _polylinearScale2.default)(animation.stops)(
                    origin
                  );
      ...
      /***/ function(module, exports) {
        ...
        function piecewise(xs, ys) {
          return function(x) {
            ...
            // project
            return (
              ys[lo] + (ys[hi] - ys[lo]) / (xs[hi] - xs[lo]) * (x - xs[lo])
            );
          };
        }
        module.exports = exports["default"];
      ...
      /***/ function(module, exports) {
        ...
        function range(start, end, max) {
          return []
            .concat(_toConsumableArray(Array(1 + end - start)))
            .map(function(val) {
        ...
        var Frame = (function(_Component) {
          ...
          function Frame(props) {
            ...
            _this._setFrameSize = function() {
              var frameSize = _this.context.pager.getFrameSize({
                fullSize: true
              });
            ...
            },
            {
              ...
              value: function _getFrameStyle() {
                ...
                return {
                  maxWidth: instant
                    ? width
                    : (0, _reactMotion.spring)(width, springConfig),
                  height: instant
                    ? height
                    : (0, _reactMotion.spring)(height, springConfig)
                };
              }
            },
            {
        ...
        var Swipe = (function() {
          function Swipe(pager) {
            ...
            this._onSwipeEnd = function() {
              ...
              var threshold = _this._isFlick
                ? swipeThreshold
                : _this.pager.currentView.getSize() *
                  viewsToMove *
                  swipeThreshold;
          ...
          function Keyboard(pager) {
            ...
            this._handleKeyDown = function(e) {
              ...
              switch (e.key) {
                ...
                // move to last view
                case "End":
                  _this.pager.setCurrentView({
                    index: _this.pager.views.length - 1
                  });
                  return;
              }
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var checkedProps = {
          ...
          viewsToShow: _propTypes2.default.oneOfType([
          ...
          springConfig: _propTypes2.default.objectOf(
            _propTypes2.default.number
          ),
          ...
          function TrackScroller() {
            ...
            return (
              (_ret = ((_temp = ((_this = _possibleConstructorReturn(
                this,
                (_ref =
                  TrackScroller.__proto__ ||
                  Object.getPrototypeOf(TrackScroller)).call.apply(
                  _ref,
                  [this].concat(args)
                )
              )),
                ...
                if (this.props.trackPosition !== trackPosition) {
                  requestAnimationFrame(function() {
                    return _this2.props.onScroll(
                      trackPosition / pager.getTrackSize(false) * -1,
                      trackPosition
                    );
                  });
                }
          ...
          function Track() {
            ...
            return (
              (_ret2 = ((_temp2 = ((_this3 = _possibleConstructorReturn(
                this,
                (_ref3 =
                  Track.__proto__ || Object.getPrototypeOf(Track)).call.apply(
                  _ref3,
                  [this].concat(args)
                )
              )),
              ...
              (_this3._currentTween = 0),
              (_this3._hydrate = false),
              (_this3._handleOnRest = function() {
            ...
            },
            {
              ...
              value: function _getTrackStyle() {
                ...
                if (!this.state.instant) {
                  trackPosition = (0, _reactMotion.spring)(
                    trackPosition,
          ...
          function View() {
            ...
            return (
              (_ret = ((_temp = ((_this = _possibleConstructorReturn(
                this,
                (_ref =
                  View.__proto__ || Object.getPrototypeOf(View)).call.apply(
                  _ref,
                  [this].concat(args)
                )
              )),
              _this)),
              (_this._viewAdded = false),
              (_this._viewInstance = null),
              _temp)),
              _possibleConstructorReturn(_this, _ret)
            );
          }
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var AnimatedView = (function(_Component) {
          ...
          function AnimatedView() {
            ...
            return _possibleConstructorReturn(
              this,
              (AnimatedView.__proto__ || Object.getPrototypeOf(AnimatedView)
            ...
            },
            {
              ...
              value: function render() {
                ...
                if (this._animationBus) {
                  var view =
                    this.context.view || this.context.pager.getView(index);
                  if (view) {
                    style = _extends(
                      {},
                      restProps.style,
